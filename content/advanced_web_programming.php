<div class="row">
	<form action="actions/checkout.php" method="POST">
		<div class="col-md-6">
			...
			<br>
			<?php 
				$query  = "SELECT p_price from product where link = 'advanced_web_programming'";
	...
	<div class="col-md-6">
		<div class = "item">
			...
			<center><img src="img/et.jpg"></center>
			<br>
			<br>
			<?php 
				$query  = "SELECT p_price from product where link = 'advanced_web_programming'";
			 ...
			 ?>
			<hr>
			<p>Total before tax:  $ 74.23 </p>
			<p>Estimated tax to be collected:	$5.40 </p>
			<hr>
			<p>Order total : $79.63</p>
		</div>
	</div>
	<br>
	<br>
