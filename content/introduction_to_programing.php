<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="row">
				<div class="col-md-6 no-left-padding">
					...
					<input style="width: 250px" name="cc" type="text" class="form-control" required>
			...
			<br>
			<?php 
				$query  = "SELECT p_price from product where link = 'introduction_to_programing'";
	...
	<div class="col-md-6">
		<div class = "item">
			...
			<center><img src="img/pro.jpg"></center>
			<br>
			<br>
			<?php 
				$query  = "SELECT p_price from product where link = 'introduction_to_programing'";
			 ...
			 ?>
			<hr>
			<p>Total before tax:  $ 53.43 </p>
			<p>Estimated tax to be collected:	$4.60 </p>
			<hr>
			<p>Order total : $58.03</p>
		</div>
	</div>
	<br>
	<br>
